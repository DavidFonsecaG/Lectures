...
public class MaterialContruccion {
    ...
    public MaterialContruccion(){

    }

    public MaterialContruccion(Integer idMaterialConstruccion, String nombreMaterial, String importado,
